...
@include('vehicleOwner.vownernav')
@section('content')
  <section id = "about"> 
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="container">
              <div class = row>
                <div class="col-md-7">
                        <a name = "form"><div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase">List Your Vehicle</h2>
                  </div>
                   {!!Form::open(['action' =>'VehiclerequestsController@tostore','method'=>'POST','enctype'=>'multipart/form-data'])!!}

                    {{Form::label('name', 'Name')}}
                    {{Form::text('name','',['class'=>'form-control','placeholder'=>'Full Name','required'])}}

                    {{Form::label('nic', 'NIC')}}
                    {{Form::text('nic','',['class'=>'form-control','placeholder'=>'National Identity Card Number','required'])}}
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="{{ asset('img/template/01-thumbnail.jpg') }}" alt="">
            </a>
